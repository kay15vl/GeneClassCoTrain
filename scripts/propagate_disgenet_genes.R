...
# get only the disgenes for tuberculosis
tb_propagated_disgenes <- final_prop_df %>% filter(mondo_id == "MONDO:0018076")

write_tsv(tb_propagated_disgenes, 
          file = "data/processed/tb_propagated_disgenet_genes.tsv")
save(final_prop_df, 
     file = "data/processed/all_disgenet_prop_genes.RData")
